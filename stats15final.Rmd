...
It may be interesting to see if certain breeds spend more time in the shelter than others. We will be use `Time.From.Last.Action` column to make a graph.
...
aac %>%
  ...
  ggtitle("breeds vs time spent in shelter")
```
